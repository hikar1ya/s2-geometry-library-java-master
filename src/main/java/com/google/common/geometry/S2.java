...
public final strictfp class S2 {
  ...
  public static class Metric {
    ...
    public int getMinLevel(double value) {
      if (value <= 0) {
        return com.google.common.geometry.S2CellId.MAX_LEVEL;
      }
      ...
      int level = Math.max(0,
          Math.min(com.google.common.geometry.S2CellId.MAX_LEVEL, -((exponent - 1) >> (dim - 1))));
   ...
   */
  public static com.google.common.geometry.S2Point origin() {
    return new com.google.common.geometry.S2Point(0, 1, 0);
  }
   ...
   */
  public static boolean isUnitLength(com.google.common.geometry.S2Point p) {
   ...
   */
  public static boolean simpleCrossing(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c, com.google.common.geometry.S2Point d) {
    ...
    com.google.common.geometry.S2Point ab = com.google.common.geometry.S2Point.crossProd(a, b);
    com.google.common.geometry.S2Point cd = com.google.common.geometry.S2Point.crossProd(c, d);
   ...
   */
  public static com.google.common.geometry.S2Point robustCrossProd(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b) {
    ...
    com.google.common.geometry.S2Point x = com.google.common.geometry.S2Point.crossProd(com.google.common.geometry.S2Point.add(b, a), com.google.common.geometry.S2Point.sub(b, a));
    if (!x.equals(new com.google.common.geometry.S2Point(0, 0, 0))) {
      return x;
    }
   ...
   * = -Ortho(a) for all a.
   */
  public static com.google.common.geometry.S2Point ortho(com.google.common.geometry.S2Point a) {
   ...
   * degrees.
   */
  static double area(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
   ...
   * triangles.
   */
  public static double girardArea(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    ...
    com.google.common.geometry.S2Point ab = com.google.common.geometry.S2Point.crossProd(a, b);
    com.google.common.geometry.S2Point bc = com.google.common.geometry.S2Point.crossProd(b, c);
    com.google.common.geometry.S2Point ac = com.google.common.geometry.S2Point.crossProd(a, c);
   ...
   */
  public static double signedArea(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
   ...
   */
  public static com.google.common.geometry.S2Point planarCentroid(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    return new com.google.common.geometry.S2Point((a.x + b.x + c.x) / 3.0, (a.y + b.y + c.y) / 3.0, (a.z + b.z + c.z) / 3.0);
  }
   ...
   */
  public static com.google.common.geometry.S2Point trueCentroid(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    ...
    double sina = com.google.common.geometry.S2Point.crossProd(b, c).norm();
    double sinb = com.google.common.geometry.S2Point.crossProd(c, a).norm();
    double sinc = com.google.common.geometry.S2Point.crossProd(a, b).norm();
    ...
    com.google.common.geometry.S2Point x = new com.google.common.geometry.S2Point(a.x, b.x, c.x);
    com.google.common.geometry.S2Point y = new com.google.common.geometry.S2Point(a.y, b.y, c.y);
    com.google.common.geometry.S2Point z = new com.google.common.geometry.S2Point(a.z, b.z, c.z);
    com.google.common.geometry.S2Point r = new com.google.common.geometry.S2Point(ra, rb, rc);
    return new com.google.common.geometry.S2Point(0.5 * com.google.common.geometry.S2Point.crossProd(y, z).dotProd(r),
        0.5 * com.google.common.geometry.S2Point.crossProd(z, x).dotProd(r), 0.5 * com.google.common.geometry.S2Point.crossProd(x, y).dotProd(r));
  }
   ...
   */
  public static boolean simpleCCW(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    ...
    return com.google.common.geometry.S2Point.crossProd(c, a).dotProd(b) > 0;
  }
   ...
   * are undefined.
   */
  public static int robustCCW(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    return robustCCW(a, b, c, com.google.common.geometry.S2Point.crossProd(a, b));
  }
   ...
   * are undefined
   */
  public static int robustCCW(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c, com.google.common.geometry.S2Point aCrossB) {
    // assert (isUnitLength(a) && isUnitLength(b) && isUnitLength(c));
   ...
   */
  private static int expensiveCCW(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    ...
    com.google.common.geometry.S2Point vab = com.google.common.geometry.S2Point.add(a, com.google.common.geometry.S2Point.mul(b, sab));
    com.google.common.geometry.S2Point vbc = com.google.common.geometry.S2Point.add(b, com.google.common.geometry.S2Point.mul(c, sbc));
    com.google.common.geometry.S2Point vca = com.google.common.geometry.S2Point.add(c, com.google.common.geometry.S2Point.mul(a, sca));
    ...
    if (dca < dbc || (dca == dbc && a.lessThan(b))) {
      if (dab < dbc || (dab == dbc && a.lessThan(c))) {
        ...
        sign = com.google.common.geometry.S2Point.crossProd(vab, vca).dotProd(a) * sab; // BC is longest
                                                             // edge
      } else {
        sign = com.google.common.geometry.S2Point.crossProd(vca, vbc).dotProd(c) * sca; // AB is longest
                                                             // edge
      }
    } else {
      if (dab < dca || (dab == dca && b.lessThan(c))) {
        sign = com.google.common.geometry.S2Point.crossProd(vbc, vab).dotProd(b) * sbc; // CA is longest
                                                             // edge
      } else {
        sign = com.google.common.geometry.S2Point.crossProd(vca, vbc).dotProd(c) * sca; // AB is longest
                                                             // edge
    ...
    int ccw =
        planarOrderedCCW(new com.google.common.geometry.R2Vector(a.y, a.z), new com.google.common.geometry.R2Vector(b.y, b.z), new com.google.common.geometry.R2Vector(c.y, c.z));
    if (ccw == 0) {
      ccw =
          planarOrderedCCW(new com.google.common.geometry.R2Vector(a.z, a.x), new com.google.common.geometry.R2Vector(b.z, b.x), new com.google.common.geometry.R2Vector(c.z, c.x));
      if (ccw == 0) {
        ccw = planarOrderedCCW(
            new com.google.common.geometry.R2Vector(a.x, a.y), new com.google.common.geometry.R2Vector(b.x, b.y), new com.google.common.geometry.R2Vector(c.x, c.y));
        // assert (ccw != 0);
      }
    }
    return ccw;
  ...
  public static int planarCCW(com.google.common.geometry.R2Vector a, com.google.common.geometry.R2Vector b) {
    // Return +1 if the edge AB is CCW around the origin, etc.
    double sab = (a.dotProd(b) > 0) ? -1 : 1;
    com.google.common.geometry.R2Vector vab = com.google.common.geometry.R2Vector.add(a, com.google.common.geometry.R2Vector.mul(b, sab));
    double da = a.norm2();
    double db = b.norm2();
    double sign;
  ...
  public static int planarOrderedCCW(com.google.common.geometry.R2Vector a, com.google.common.geometry.R2Vector b, com.google.common.geometry.R2Vector c) {
    int sum = 0;
    sum += planarCCW(a, b);
    sum += planarCCW(b, c);
    sum += planarCCW(c, a);
   ...
   * </ol>
   */
  public static boolean orderedCCW(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c, com.google.common.geometry.S2Point o) {
   ...
   * degrees.
   */
  public static double angle(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    return com.google.common.geometry.S2Point.crossProd(a, b).angle(com.google.common.geometry.S2Point.crossProd(c, b));
  }
   ...
   */
  public static double turnAngle(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, com.google.common.geometry.S2Point c) {
    ...
    double outAngle = com.google.common.geometry.S2Point.crossProd(b, a).angle(com.google.common.geometry.S2Point.crossProd(c, b));
   ...
   */
  public static boolean approxEquals(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b, double maxError) {
    return a.angle(b) <= maxError;
  }

  public static boolean approxEquals(com.google.common.geometry.S2Point a, com.google.common.geometry.S2Point b) {
